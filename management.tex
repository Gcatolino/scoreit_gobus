...
\begin{itemize}
	\item {\bf{Avvio}}: Raggruppa i processi necessari a selezionare un progetto in relazione a specifici obiettivi di business, definendo obiettivi e modalit\`{a} di gestione del progetto.
...
Viene inoltre definito il ruolo del Project Manager nell\rq ambito del progetto. A fini didattici, tale ruolo viene ricoperto a turno dai diversi membri del team.
